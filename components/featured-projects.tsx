export default function FaeturedProjects() {
  return (
    <section>
      <h2 className="font-aspekta text-xl font-[650] mb-5">Core Values / Pillars</h2>

      {/* Cards */}
      <div className="grid sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
        <a
        ...
        >
          <div className="flex flex-col h-full">
            <div className="grow">
              ...
              <div className="text-lg font-aspekta font-[650] mb-1">Intergrity</div>
              <p className="text-sm text-slate-500 dark:text-slate-400 mb-2">Doing what is right with honesty, transparency, and unwavering principles.</p>
            </div>
        ...
        >
          <div className="flex flex-col h-full">
            <div className="grow">
              ...
              <div className="text-lg font-aspekta font-[650] mb-1">Service</div>
              <p className="text-sm text-slate-500 dark:text-slate-400 mb-2">Putting people first and leading with humility and purpose.</p>
            </div>
            <div className="text-sky-500 flex justify-end">
              <svg className="fill-current" xmlns="http://www.w3.org/2000/svg" width="14" height="12">
                <path d="M9.586 5 6.293 1.707 7.707.293 13.414 6l-5.707 5.707-1.414-1.414L9.586 7H0V5h9.586Z" />
        ...
        >
          <div className="flex flex-col h-full">
            <div className="grow">
              ...
              <div className="text-lg font-aspekta font-[650] mb-1">Action</div>
              <p className="text-sm text-slate-500 dark:text-slate-400 mb-2">Hon. Nnamdi Okoye believes in Turning promises into measurable results and visible progress.</p>
            </div>
        ...
        >
          <div className="flex flex-col h-full">
            <div className="grow">
              ...
              <div className="text-lg font-aspekta font-[650] mb-1">Accountability</div>
              <p className="text-sm text-slate-500 dark:text-slate-400 mb-2">Remaining accessible, responsible, and answerable to the people at all times.</p>
            </div>
            <div className="text-sky-500 flex justify-end">
              <svg className="fill-current" xmlns="http://www.w3.org/2000/svg" width="14" height="12">
                <path d="M9.586 5 6.293 1.707 7.707.293 13.414 6l-5.707 5.707-1.414-1.414L9.586 7H0V5h9.586Z" />
        ...
        >
          <div className="flex flex-col h-full">
            <div className="grow">
              ...
              <div className="text-lg font-aspekta font-[650] mb-1">Empowerment</div>
              <p className="text-sm text-slate-500 dark:text-slate-400 mb-2">Creating opportunities that help individuals, families, and communities thrive.</p>
            </div>
        ...
        >
          <div className="flex flex-col h-full">
            <div className="grow">
              ...
              <div className="text-lg font-aspekta font-[650] mb-1">Progress</div>
              <p className="text-sm text-slate-500 dark:text-slate-400 mb-2">Driving sustainable development that improves lives and strengthens communities.</p>
            </div>
            <div className="text-sky-500 flex justify-end">
              <svg className="fill-current" xmlns="http://www.w3.org/2000/svg" width="14" height="12">
                <path d="M9.586 5 6.293 1.707 7.707.293 13.414 6l-5.707 5.707-1.414-1.414L9.586 7H0V5h9.586Z" />
